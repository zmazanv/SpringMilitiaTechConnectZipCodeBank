...
public class AccountController {
    ...
    public ResponseEntity<?> getAccountById(@PathVariable Long accountId) {
        ...
        logger.info("Fetching all accounts for account ID: {}", accountId);
        int successResponseCode = HttpStatus.OK.value();
        ...
        logger.info("Successfully fetched all Account with account ID: {}", accountId);
        return (new ResponseEntity<>(successResponse, HttpStatus.OK));
    }
    ...
    public ResponseEntity<?> getAllAccountsByCustomerId (@PathVariable Long customerId) {
        ...
        logger.info("Fetching all Accounts for customer ID: {}", customerId);
        int successResponseCode = HttpStatus.OK.value();
        ...
        SuccessResponse<Iterable<Account>> successResponse = new SuccessResponse<>(successResponseCode, successResponseMessage, successResponseData);
        logger.info("Successfully fetched all Accounts for customer ID: {}", customerId);
        return (new ResponseEntity<>(successResponse, HttpStatus.OK));
    }
    ...
    public ResponseEntity<?> createAccount(@PathVariable Long customerId, @Valid @RequestBody AccountCreateDTO accountCreateDTO) {
        ...
        logger.info("Creating account for customer");
    ...
    public ResponseEntity<?> deleteAccount(@PathVariable Long accountId) {
        ...
        logger.info("Successfully deleted all accounts for accounts with an ID: {}", accountId);
